        ...
        <div className={cx.wrapper}>
            <Slider
                slides={[
                    ...
                    },
                    {
                        ...
                        descriptionStyle: styleParser(
                            data.description_2page_param
                        ),
            ...
            <div className={cx.links}>
                <div className={cx.bricks}>
                    ...
                    <Button variant="contained" endIcon={<RightArrowIcon />}>
                        больше
                    </Button>
                ...
                <div className={cx.main}>
                    {data.heading && (
                        <Typography
                            variant="h3"
                            style={styleParser(data.heading1_param) || ''}
                        >
                            {data.heading}
                        </Typography>
                    )}
                    {data.text1_block && (
                        <p style={styleParser(data.text1_block_param)}>
                            {data.text1_block}
                        </p>
                    )}
                </div>
            ...
            <div className={cx.gallery}>
                <EditableImage
                    className={cx.image}
                    isEditing={isEditing}
                    src={data.image_header1 || undefined}
                    name="image_header1"
                />
                <EditableImage
                    className={cx.image}
                    isEditing={isEditing}
                    src={data.image_header2 || undefined}
                    name="image_header2"
                />
                <EditableImage
                    className={cx.image}
                    isEditing={isEditing}
                    src={data.image_header3 || undefined}
                    name="image_header2"
                />
                <div className={cx.title}>
                    {data.heading2 && (
                        <Typography
                            variant="h3"
                            style={styleParser(data.heading2_param)}
                        >
                            {data.heading2}
                        </Typography>
                    )}
                    {data.text2_block && (
                        <p style={styleParser(data.text2_block_param)}>
                            {data.text2_block}
                        </p>
                    )}
                    ...
                    {data.text2 && (
                        <Typography
                            ...
                            variant="h3"
                            style={styleParser(data.text2_param)}
                        >
                            {data.text2}
                        </Typography>
                    )}
