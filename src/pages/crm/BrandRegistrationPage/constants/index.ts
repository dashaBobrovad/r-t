export const freelanceFormFields = [
    [
        {
            label: 'Наименование партнера (полное наименование юридического лица / ФИО физического лица, осуществляющего предпринимательскую деятельность / иное наименование,если применимо)*',
            name: 'companyName',
        },
        {
            label: 'ФИО уполномоченного руководителя / наименование единоличногоисполнительного органа*',
            name: 'ownerName',
        },
        {
        ...
        {
            label: 'Торговое / коммерческое наименование (это наименование будет видно всем покупателям)*',
            name: 'titleName',
        },
        {
